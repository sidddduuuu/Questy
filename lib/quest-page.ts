...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at 10% 0,#f7c99f,transparent 28rem),var(--paper);color:var(--ink);font-family:Arial,sans-serif}
    ...
    article{margin-top:24px;padding:clamp(28px,7vw,56px);border:1px solid var(--line);border-radius:28px;background:#fffdf7}h1{margin:0 0 24px;font:500 clamp(2.8rem,9vw,5.6rem)/.95 Georgia,serif;letter-spacing:-.055em}
