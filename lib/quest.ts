...
const fallbackPlans = {
  ...
  omar: {
    ...
    socialPost: "Hey team — join me for a quieter Tuesday lunch between 1:30 and 3:00 PM. Pick your time and lunch choice in the RSVP; our group gets 20% off.",
    ...
    requiredCapabilities: ["private invite copy", "professional lunch image", "coworker RSVP form", "hosted invitation page"],
  },
  lena: {
